...
`,A={type:"code",component:function(){return l.createElement(k,{actions:E,nothingFound:"Nothing found...",highlightQuery:!0,shortcut:null,searchProps:{leftSection:l.createElement(d.Z,{style:{width:(0,m.h)(20),height:(0,m.h)(20)},stroke:1.5}),placeholder:"Search..."}})},code:C},M=`
import { rem, Button } from '@mantine/core';
import { Spotlight, SpotlightActionData, spotlight } from '@mantine/spotlight';
...
`,O=Array(3e3).fill(0).map((e,t)=>({id:`action-${t}`,label:`Action ${t}`,description:`Action ${t} description`})),B={type:"code",component:function(){return l.createElement(k,{actions:O,nothingFound:"Nothing found...",highlightQuery:!0,limit:7,shortcut:null,searchProps:{leftSection:l.createElement(d.Z,{style:{width:(0,m.h)(20),height:(0,m.h)(20)},stroke:1.5}),placeholder:"Search..."}})},code:M},I=`
import { rem, Button } from '@mantine/core';
import { Spotlight, SpotlightActionData, spotlight } from '@mantine/spotlight';
import { IconSearch } from '@tabler/icons-react';
...
`,N=Array(100).fill(0).map((e,t)=>({id:`action-${t}`,label:`Action ${t}`,description:`Action ${t} description`})),D={type:"code",component:function(){return l.createElement(k,{actions:N,nothingFound:"Nothing found...",highlightQuery:!0,scrollable:!0,maxHeight:350,shortcut:null,searchProps:{leftSection:l.createElement(d.Z,{style:{width:(0,m.h)(20),height:(0,m.h)(20)},stroke:1.5}),placeholder:"Search..."}})},code:I},Z=`
import { rem, Button } from '@mantine/core';
...
`,P=[{group:"Pages",actions:[{id:"home",label:"Home page",description:"Where we present the product"},{id:"careers",label:"Careers page",description:"Where we list open positions"},{id:"about-us",label:"About us page",description:"Where we tell what we do"}]},{group:"Apps",actions:[{id:"svg-compressor",label:"SVG compressor",description:"Compress SVG images"},{id:"base64",label:"Base 64 converter",description:"Convert data to base 64 format"},{id:"fake-data",label:"Fake data generator",description:"Lorem ipsum generator"}]}],$={type:"code",component:function(){return l.createElement(k,{actions:P,nothingFound:"Nothing found...",highlightQuery:!0,shortcut:null,searchProps:{leftSection:l.createElement(d.Z,{style:{width:(0,m.h)(20),height:(0,m.h)(20)},stroke:1.5}),placeholder:"Search..."}})},code:Z};var F=o(75788),L=o(56903),H=o(77048),z=o(23733);let G=`
...
`,c=["Home","About us","Contacts","Blog","Careers","Terms of service"],h={type:"code",component:function(){let[e,t]=(0,n.useMemo)(i.Gv,[]),[o,a]=(0,n.useState)(""),h=c.filter(e=>e.toLowerCase().includes(o.toLowerCase().trim())).map(e=>n.createElement(r.$.Action,{key:e,label:e}));return n.createElement(n.Fragment,null,n.createElement(s.z,{onClick:t.open},"Open spotlight"),n.createElement(r.$.Root,{store:e,query:o,onQueryChange:a,shortcut:null},n.createElement(r.$.Search,{placeholder:"Search...",leftSection:n.createElement(l.Z,{stroke:1.5})}),n.createElement(r.$.ActionsList,null,h.length>0?h:n.createElement(r.$.Empty,null,"Nothing found..."))))},code:a,centered:!0}}},function(e){e.O(0,[1300,178,9774,2888,179],function(){return e(e.s=70601)}),_N_E=e.O()}]);